...
class AcuteTourismSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $experiences = collect([
            [
                'title' => 'Private Heritage Desert Safari Dubai',
                'slug' => 'private-heritage-desert-safari',
                'category' => 'Desert',
                'short_description' => 'Private Dubai desert safari with hotel pickup, hosted camp access, dinner, and relaxed evening pacing.',
                'hero_summary' => 'A flagship desert itinerary framed for premium private travelers.',
                'description' => 'This private desert safari is designed for guests who want a more comfortable and less crowded Dubai desert experience. From hotel pickup to dinner at the camp, the evening is paced around your group with smoother coordination and a more relaxed atmosphere.',
                'hero_image_path' => 'https://acutetourism.org/uploads/0000/7/2025/03/29/desert-safari-premium-miniatura.png',
                'gallery_images' => [
                ...
                'highlights' => [
                    'Private experience with relaxed pacing',
                    'Premium desert setting',
                    'Hosted camp access',
                    'Sunset timing for better photos',
                    'Ideal for couples and families',
                    'Comfort over a standard shared safari',
                ],
                'inclusions' => [
                    'Private hotel pickup and drop-off',
                    'Comfortable desert transfer',
                    'Sunset desert photo stop',
                    'Hosted camp access',
                    'Dinner experience',
                    'Soft drinks and refreshments',
                    'Camp activities depending on availability',
                    'Pickup coordination after confirmation',
                ],
                'exclusions' => [
                    'Professional photography unless arranged separately',
                    'Quad bike or buggy activities unless added',
                    'Personal expenses',
                    'Special celebration setup unless requested',
                    'Tips and gratuities',
